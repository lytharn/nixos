...
hl.config({
  general = {
    border_size = 2,
    col = {
      active_border = { colors = { "rgba(@colRed@ff)", "rgba(@colBlue@ff)" }, angle = 45 },
      inactive_border = { colors = { "rgba(@colComment@ff)" } },
    },
  },
  decoration = {
    rounding = 5,
...
hl.bind(mod .. " + F4", hl.dsp.exec_cmd("hyprshutdown"))
hl.bind(mod .. " + F5", hl.dsp.exec_cmd("hyprshutdown --post-cmd 'systemctl reboot'"))
hl.bind(mod .. " + F9", hl.dsp.exec_cmd("hyprshutdown --post-cmd 'systemctl poweroff'"))
